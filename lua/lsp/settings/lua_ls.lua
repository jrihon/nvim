-- I AM TRYING TO GET THESE SETTINGS WORKED INTO THE MASON-LSPCONFIG, BUT SO FAR NO LUCK
-- THIS FILE NEEDS TO BE REQUIRED() BY THE MASON LSP OR SOME SHIT
...
--      local root = util.root_pattern(table.unpack(root_files))(fname)
